...
abstract class MessageRepository {
  ...
  /// 
  /// [message] 要发送的消息
  Future<Result<MessageModel>> sendMessage(MessageModel message);
  ...
  /// 
  /// [messageId] 要标记的消息ID
  Future<Result<void>> markMessageAsRead(String messageId);
  
  /// 标记会话中的所有消息为已读
  /// 
  /// [conversationId] 会话ID
  Future<Result<void>> markAllMessagesAsRead(String conversationId);
  
  /// 获取未读消息数量
  /// 
  /// [userId] 用户ID
  Future<Result<int>> getUnreadMessageCount(String userId);
