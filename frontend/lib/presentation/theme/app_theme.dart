...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(color: lightTextColor, fontSize: 24, fontWeight: FontWeight.bold),
      displayMedium: TextStyle(color: lightTextColor, fontSize: 22, fontWeight: FontWeight.bold),
      displaySmall: TextStyle(color: lightTextColor, fontSize: 20, fontWeight: FontWeight.bold),
      headlineMedium: TextStyle(color: lightTextColor, fontSize: 18, fontWeight: FontWeight.bold),
      headlineSmall: TextStyle(color: lightTextColor, fontSize: 16, fontWeight: FontWeight.bold),
      titleLarge: TextStyle(color: lightTextColor, fontSize: 16, fontWeight: FontWeight.w500),
      titleMedium: TextStyle(color: lightTextColor, fontSize: 14, fontWeight: FontWeight.w500),
      titleSmall: TextStyle(color: lightTextColor, fontSize: 12, fontWeight: FontWeight.w500),
      ...
      labelSmall: TextStyle(color: lightSecondaryTextColor, fontSize: 10),
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(color: darkTextColor, fontSize: 24, fontWeight: FontWeight.bold),
      displayMedium: TextStyle(color: darkTextColor, fontSize: 22, fontWeight: FontWeight.bold),
      displaySmall: TextStyle(color: darkTextColor, fontSize: 20, fontWeight: FontWeight.bold),
      headlineMedium: TextStyle(color: darkTextColor, fontSize: 18, fontWeight: FontWeight.bold),
      headlineSmall: TextStyle(color: darkTextColor, fontSize: 16, fontWeight: FontWeight.bold),
      titleLarge: TextStyle(color: darkTextColor, fontSize: 16, fontWeight: FontWeight.w500),
      titleMedium: TextStyle(color: darkTextColor, fontSize: 14, fontWeight: FontWeight.w500),
      titleSmall: TextStyle(color: darkTextColor, fontSize: 12, fontWeight: FontWeight.w500),
      ...
      labelMedium: TextStyle(color: accentColor, fontSize: 12, fontWeight: FontWeight.w500),
      labelSmall: TextStyle(color: darkSecondaryTextColor, fontSize: 10),
    ),
    inputDecorationTheme: InputDecorationTheme(
      filled: true,
