...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      bodyLarge: TextStyle(color: lightTextColor, fontSize: fontSizeNormal),
      bodyMedium: TextStyle(color: lightTextColor, fontSize: fontSizeNormal),
      bodySmall: TextStyle(color: lightSecondaryTextColor, fontSize: fontSizeSmall),
      titleLarge: TextStyle(color: lightTextColor, fontSize: fontSizeLarge, fontWeight: FontWeight.bold),
      titleMedium: TextStyle(color: lightTextColor, fontSize: fontSizeMedium, fontWeight: FontWeight.bold),
      titleSmall: TextStyle(color: lightTextColor, fontSize: fontSizeNormal, fontWeight: FontWeight.bold),
    ),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      bodyLarge: TextStyle(color: darkTextColor, fontSize: fontSizeNormal),
      bodyMedium: TextStyle(color: darkTextColor, fontSize: fontSizeNormal),
      bodySmall: TextStyle(color: darkSecondaryTextColor, fontSize: fontSizeSmall),
      titleLarge: TextStyle(color: darkTextColor, fontSize: fontSizeLarge, fontWeight: FontWeight.bold),
      titleMedium: TextStyle(color: darkTextColor, fontSize: fontSizeMedium, fontWeight: FontWeight.bold),
      titleSmall: TextStyle(color: darkTextColor, fontSize: fontSizeNormal, fontWeight: FontWeight.bold),
    ),
    appBarTheme: const AppBarTheme(
